// js/commentary-fallback.js  v23.0
// Inline copy of cma_commentary.md body — used when fetch() is unavailable
// (e.g. file:// protocol). Auto-generated — do not edit manually.
// To update, re-run the build script or replace cma_commentary.md and redeploy.
export const COMMENTARY_FALLBACK = `---
