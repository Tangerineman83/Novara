...
export const ASSET_CLASSES = [
    ...
    { key: "ukEq", name: "UK Equity", defaultR: 0.065, defaultV: 0.15, defaultK: 1.8, color: "#3B82F6" },
    { key: "devEq", name: "Dev Europe Eq", defaultR: 0.070, defaultV: 0.16, defaultK: 1.6, color: "#60A5FA" },
    { key: "emEq", name: "EM Equity", defaultR: 0.085, defaultV: 0.20, defaultK: 2.5, color: "#93C5FD" },
    { key: "globalReits", name: "Global REITs", defaultR: 0.060, defaultV: 0.18, defaultK: 2.0, color: "#6D28D9" },
    { key: "listedAlts", name: "Listed Alts", defaultR: 0.055, defaultV: 0.12, defaultK: 1.5, color: "#8B5CF6" },
    { key: "privAssets", name: "Div. Private Assets", defaultR: 0.075, defaultV: 0.12, defaultK: 3.0, color: "#A78BFA" },
    { key: "privEq", name: "Private Equity", defaultR: 0.095, defaultV: 0.22, defaultK: 4.5, color: "#B45309" },
    { key: "infrastructure", name: "Infrastructure", defaultR: 0.065, defaultV: 0.11, defaultK: 2.0, color: "#D97706" },
    { key: "privCredit", name: "Private Credit", defaultR: 0.075, defaultV: 0.09, defaultK: 3.5, color: "#F59E0B" },
    { key: "globalHighYield", name: "Global High Yield", defaultR: 0.060, defaultV: 0.10, defaultK: 2.5, color: "#FBBF24" },
    { key: "emDebt", name: "EM Debt", defaultR: 0.065, defaultV: 0.12, defaultK: 2.5, color: "#047857" },
...
export const PRESET_CMAS = [
    {
        ...
        data: {
            ...
            k: { usEq: 1.5, ukEq: 1.8, devEq: 1.6, emEq: 2.5, globalReits: 2.0, listedAlts: 1.5, privAssets: 3.0, emDebt: 2.5, igCredit: 1.2, sdCredit: 1.0, moneyMkt: 0.0, privEq: 4.5, infrastructure: 2.0, privCredit: 3.5, globalHighYield: 2.5, inflLinked: 0.5, globalSov: 0.5 },
...
export const PRESET_PORTFOLIOS = [
    {
        ...
        portfolios: [
            { id: "p_std_growth", name: "Standard Growth", weights: { usEq: 0.60, devEq: 0.15, emEq: 0.13, ukEq: 0.05, globalReits: 0.05, privAssets: 0.02 } },
            { id: "p_enh_growth", name: "Enhanced Growth", weights: { usEq: 0.45, devEq: 0.1125, emEq: 0.0975, ukEq: 0.0375, globalReits: 0.0375, privAssets: 0.015, privEq: 0.0833, infrastructure: 0.0833, privCredit: 0.0834 } },
            { id: "p_retire", name: "Retirement", weights: { sdCredit: 0.248, usEq: 0.192, igCredit: 0.150, emDebt: 0.092, devEq: 0.072, globalSov: 0.057, emEq: 0.050, moneyMkt: 0.040, ukEq: 0.026, globalReits: 0.025, inflLinked: 0.025, privAssets: 0.023 } }
        ]
    }
];
