...
export const PRESET_CMAS = [
    {
        ...
        data: {
            r: { 
                usEq: 0.065, devEq: 0.072, emEq: 0.088, jpnEq: 0.070, ukEq: 0.065, apacEq: 0.072, 
                ...
                globalHighYield: 0.078, emDebt: 0.075, igCredit: 0.054, sdCredit: 0.0425, 
                globalSov: 0.045, inflLinked: 0.045, moneyMkt: 0.035 
            },
            v: { 
                usEq: 0.155, devEq: 0.150, emEq: 0.230, jpnEq: 0.170, ukEq: 0.140, apacEq: 0.185, 
                ...
                globalSov: 0.075, inflLinked: 0.065, moneyMkt: 0.010 
            },
            k: { 
                ...
                globalSov: 1.80, inflLinked: 2.00, moneyMkt: 0.15 
            },
            correlations: {
                usEq: { usEq: 1.00, devEq: 0.75, emEq: 0.68, jpnEq: 0.45, ukEq: 0.65, apacEq: 0.55, globalReits: 0.75, realEstateDirect: 0.40, infrastructure: 0.45, privEq: 0.88, privCredit: 0.42, listedAlts: 0.65, digitalAssets: 0.55, globalHighYield: 0.62, emDebt: 0.50, igCredit: 0.35, sdCredit: 0.25, globalSov: -0.05, inflLinked: 0.12, moneyMkt: 0.00 },
                ...
                digitalAssets: { usEq: 0.55, devEq: 0.30, emEq: 0.40, jpnEq: 0.25, ukEq: 0.25, apacEq: 0.35, globalReits: 0.25, realEstateDirect: 0.15, infrastructure: 0.20, privEq: 0.35, privCredit: 0.35, listedAlts: 0.30, digitalAssets: 1.00, globalHighYield: 0.35, emDebt: 0.40, igCredit: 0.05, sdCredit: 0.05, globalSov: -0.10, inflLinked: -0.05, moneyMkt: 0.00 },
...
export const STRESS_SCENARIOS = [
    ...
    },
    {
        ...
        description: "Aggressive fiscal stimulus and deregulation scenario driving broad risk asset appreciation.",
    ...
    {
        id: "s_2026_iran_war", name: "Iran Energy Shock (2026)",
        description: "Strait of Hormuz closure; largest geopolitical oil supply disruption in recorded history. Energy import shock drives inflation surge and hawkish rate repricing.",
        returns: { usEq: -0.170, devEq: -0.220, emEq: -0.200, jpnEq: -0.160, ukEq: -0.120, apacEq: -0.190, globalReits: -0.160, realEstateDirect: -0.100, infrastructure: 0.070, privEq: -0.120, privCredit: -0.060, listedAlts: -0.130, digitalAssets: -0.250, globalHighYield: -0.110, emDebt: -0.180, igCredit: -0.130, sdCredit: -0.040, globalSov: -0.060, inflLinked: 0.100, moneyMkt: 0.050 }
    },
    {
